    ...
    return (
        <div className="about-container">
            ...
            <main className="about-content">
                ...
                <p>Besides software, I like doing things like playing pickleball, going on walks with my dog, and sometimes doing 3D modeling in Blender. Some of my guilty pleasures are (unfortunately) playing League of Legends and watching K-dramas.</p>
