            ...
            <main className="home-content">
                <section className="home-intro">
                    <div className="intro-container">
                        ...
                        <p>I’m a recent <span>Software Engineering Graduate</span> focused on <span>Full-Stack Development</span>. Right now, I’m improving my existing skills while gradually learning new ones, including low-level programming and systems fundamentals. I’m also beginning a Master’s degree at <a href="https://omscs.gatech.edu/" target="_blank">Georgia Tech</a> this fall, where I plan to specialize in computing systems all while keeping my focus on full-time industry work.</p>
                    </div>
