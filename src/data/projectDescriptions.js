...
const projectDescriptions = {
    "dotfiles" : [
        '"I use arch btw!"',
        "These config files take huge inspiration from other people's work, but at this point I've changed so much about them through countless tweaks and revisions that I'm happy to call them my own",
